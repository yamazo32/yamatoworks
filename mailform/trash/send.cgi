...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'info@yamatoworks.net';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'https://yamatoworks.net/contact/';
...
━━━━━━━━━━━━━━━━━━━━━━━━━━
　ヤマトワークス / YAMATOWORKS
　〒002-0003 岩手県大船渡市盛町字権現堂十二番一号
　TEL / 0192-22-8418　FAX / 0192-22-8418
　https://yamatoworks.net
━━━━━━━━━━━━━━━━━━━━━━━━━━
__res_body_eof__
		...
		if(!$conf{'debug'}){
			...
			if(@mailto > 0){
				...
				for($cnt=0;$cnt<@mailto;$cnt++){
					&sendmail($mailto[$cnt], $mailto[$cnt], $conf{'subject'}, $admin_posted_body);
				}
